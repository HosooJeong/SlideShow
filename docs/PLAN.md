...
| 단계                    | 상태    | 메모                                                                                                                                                          |
| ----------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0. 셋업                 | ✅      | PR #1, #2. GitHub Pages 배포 동작                                                                                                                             |
| 1. 미디어               | ✅      | PR #3. 업로드·썸네일·IndexedDB·정렬·삭제                                                                                                                      |
| 1.5 실험실              | 🔶 진행 | A1·B2·B3·C1 구현·판정(PR #3, #4). 남은 티어 A: C3 디스플레이스먼트 전환, D2 파티클, D3 플래시, E1 SDF 텍스트                                                  |
| 2. 렌더 엔진 + 플레이어 | ✅      | 종이 무대 컴포저, `render(composition, t)`(frameloop demand), 살아있는 사진(켄번즈+하프톤+잉크 등장), DOF·필름, 플레이어(재생/시크/다시 섞기/전체화면/키보드) |
| 3. 마법 신문 무대       | ⬜ 다음 | 페이지·헤드라인·기사·광고 문구, 오프닝, 페이지 넘김                                                                                                           |
